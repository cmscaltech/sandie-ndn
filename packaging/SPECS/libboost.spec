...
Version:        %{ver}
Release:        1
Source0: http://sourceforge.net/projects/boost/files/boost/%{lib_appendix}/boost_%{lib_appendix}.tar.gz
...
cp /root/rpmbuild/BUILD/boost_%{lib_appendix}/LICENSE_1_0.txt %{buildroot}%{_docdir}/
#symlink dupes
%if 0%{?suse_version} > 1020
%fdupes %buildroot
%endif

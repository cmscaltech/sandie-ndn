...
%define ver 1.69.0
%define git_tag 1.69.0
%define lib_appendix 1_69_0
...
%define boost_libs4 libboost_system%{lib_appendix} libboost_thread%{lib_appendix}
...
Summary:        The Boost::contract runtime library
Group:          System/Libraries
Requires:       boost-license%{lib_appendix}

%description    -n libboost_contract%{lib_appendix}
This package contains the Boost:contract runtime library.

%package        -n libboost_fiber%{lib_appendix}

Summary:        The Boost::fiber runtime library
Group:          System/Libraries
Requires:       boost-license%{lib_appendix}

%description    -n libboost_fiber%{lib_appendix}
This package contains the Boost:fiber runtime library.

%package        -n libboost_stacktrace_addr2line%{lib_appendix}

Summary:        The Boost::stacktrace_addr2line runtime library
Group:          System/Libraries
Requires:       boost-license%{lib_appendix}

%description    -n libboost_stacktrace_addr2line%{lib_appendix}
This package contains the Boost:stacktrace_addr2line runtime library.

%package        -n libboost_stacktrace_basic%{lib_appendix}

Summary:        The Boost::stacktrace_basic runtime library
Group:          System/Libraries
Requires:       boost-license%{lib_appendix}

%description    -n libboost_stacktrace_basic%{lib_appendix}
This package contains the Boost:stacktrace_basic runtime library.

%package        -n libboost_stacktrace_noop%{lib_appendix}

Summary:        The Boost::stacktrace_noop runtime library
Group:          System/Libraries
Requires:       boost-license%{lib_appendix}

%description    -n libboost_stacktrace_noop%{lib_appendix}
This package contains the Boost:stacktrace_noop runtime library.

%package        -n libboost_type_erasure%{lib_appendix}

Summary:        The Boost::type_erasure runtime library
Group:          System/Libraries
Requires:       boost-license%{lib_appendix}

%description    -n libboost_type_erasure%{lib_appendix}
This package contains the Boost:type_erasure runtime library.
...
cd boost
git checkout tags/%{name}-%{git_tag}
git submodule update --init

#everything in the git repo has the executable flag set ...
...
%postun -n libboost_stacktrace_addr2line%{lib_appendix} -p /sbin/ldconfig

%postun -n libboost_stacktrace_basic%{lib_appendix} -p /sbin/ldconfig

%postun -n libboost_stacktrace_noop%{lib_appendix} -p /sbin/ldconfig
...
%files -n libboost_stacktrace_addr2line%{lib_appendix}
%defattr(-, root, root, -)
%{_libdir}/libboost_stacktrace_addr2line*.so.*

%files -n libboost_stacktrace_basic%{lib_appendix}
%defattr(-, root, root, -)
%{_libdir}/libboost_stacktrace_basic*.so.*

%files -n libboost_stacktrace_noop%{lib_appendix}
%defattr(-, root, root, -)
...
%changelog
* Sat Apr 20 2019 Catalin Iordache <catalin.iordache@cern.ch> 1.69.0
- 1.69.0 Version boost 1.69.0
* Mon Jun 08 2015 Vicente Dominguez <twitter:@vicendominguez> 1.58.0
- 1.58.0 MPI excluded
* Wed Apr 1 2015 Vicente Dominguez <twitter:@vicendominguez> 1.57.0
- 1.57.0 version with MPI excluded
* Wed Dec 24 2014 Vicente Dominguez <twitter:@vicendominguez> 1.56.0
- 1.56.0 version with MPI excluded
* Thu Apr 10 2014 Vicente Dominguez <twitter:@vicendominguez> 1.55.0
- 1.55.0 version/adaptation
